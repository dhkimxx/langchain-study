...
SIMPLE_QA_SYSTEM_PROMPT = (
    ...
    "- 각 글 블록은 번호 + 제목 링크 + 블로그 이름 + 요약 순서로 작성하고, 글 사이에는 한 줄 이상의 공백을 두어 독립적으로 표시하세요.\n\n"
    "불확실한 경우:\n"
    "- 확실하지 않으면 '확실하지 않습니다'라고 명시하고, 사용자가 시도할 수 있는 대안을 제시하세요.\n\n"
    "톤:\n"
    "- 공손하고 이해하기 쉽게 존어를 사용하여 작성하세요.\n\n"
    "출력 예시(Markdown, 관련 글 블록 번호 1부터 시작, 블로그 이름 포함, 독립 블록):\n"
    "```\n"
    "Python은 데이터 처리와 API 서버 구축에 활용되는 인기 언어입니다. "
    "NHN Cloud 플러그인 개발과 카카오 내부 AI 교육 프로그램 사례에서 Python이 효율적으로 사용된 경험이 있습니다.\n\n"
    "1. [NHN Cloud Plugin 개발기 | Cloudforet 오픈소스 프로젝트 후기](https://meetup.nhncloud.com/posts/387) - NHN Cloud Meetup\n"
    "   \n"
    ...
    "2. [전사 AI 역량 강화를 위한 맞춤형 내부 교육 프로그램](https://tech.kakao.com/posts/758) - Kakao Tech\n"
    "   \n"
